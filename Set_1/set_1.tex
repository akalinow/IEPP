...
Please calculate numerical values following physical constants:
\begin{itemize}
...
using $h$ and $c$ values from CODATA 2022:
\begin{itemize}
\item $h = 6.626 \times 10^{-34}\,\mathrm{J\,s}$
\item $c = 2.998 \times 10^8\,\mathrm{m/s}$
\item $1 \mathrm{e} = 1.602 \times 10^{-19}\,\mathrm{C}$
...
Please calculate cross section for back-scattering: $\theta = \pi \pm 5^\circ$ of 
...
Alpha particle has mass $m_\alpha = 4$ u. Assume $\theta = \pi$ for the whole
backscattering range. 
...
Differential crosssection at $\theta = \pi$ is given by:
\begin{align*}
\frac{d\sigma}{d\Omega} = 
